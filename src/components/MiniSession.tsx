...
export default function MiniSession({
  timeLeft, pointsEarned, isOnTask, trackingPaused,
  onExpand, onTogglePause, onEnd,
}: Props) {
  return (
    <div className={styles.container}>
      <div className={styles.left}>
        ...
        <span className={`${styles.dot} ${isOnTask ? styles.dotOn : styles.dotOff}`} />
      </div>
      ...
      <div className={styles.right}>
        ...
        {/* End session */}
        <button className={`${styles.iconBtn} ${styles.iconBtnEnd}`} onClick={onEnd} title="End session">
