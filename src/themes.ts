...
export const themes: Record<string, Theme> = {
  default: {
    ...
    vars: {
      ...
      '--pink-20': 'rgba(207, 110, 131, 0.1)',
      '--pink-30': 'rgba(207, 110, 131, 0.1)',
      '--pink-40': 'rgba(207, 110, 131, 0.1)',
      '--pink-50': 'rgba(207, 110, 131, 0.1)',
      '--pink-60': 'rgba(207, 110, 131, 0.1)',
      '--pink-70': 'rgba(207, 110, 131, 0.1)',
      '--pink-80': 'rgba(207, 110, 131, 0.1)',
      '--pink-90': 'rgba(207, 110, 131, 0.1)',
      '--status-green':    '#4CCE7A',
      '--status-red':      '#E05555',
      '--status-amber':    '#E6A817',
  },
